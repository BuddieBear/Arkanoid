 ...
 *
 * <p>The paddle can move horizontally, change size through power-ups, and has different movement strategies.
 */
public class Paddle extends MovableObject {
  ...
  /**
   * Extends the paddle's width by the expansion amount.
   * Adjusts position to maintain center alignment.
   */
  ...
  /**
   * Shrinks the paddle's width by the shrink amount.
   * Adjusts position to maintain center alignment.
   */
