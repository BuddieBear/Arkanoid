...
public class BrickView implements View {
  ...
  public void onDraw(GraphicsContext gc, Canvas canvas) {
    ...
    drawRoundedImage(gc, Basis.BRICK_NORMAL_TEXTURE_1, x, scrollY + 100, widthImage, heightImage,
        radius);
    gc.fillText("Cần 1 va chạm để phá", x + 450, scrollY + 100 + heightImage / 2);
    drawRoundedImage(gc, Basis.BRICK_NORMAL_TEXTURE_2[1], x, scrollY + 100 + heightImage + space,
