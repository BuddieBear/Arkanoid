...
public class LevelPlay {
  ...
  public void onDraw(GraphicsContext gc) {
    ...
    gc.drawImage(Basis.TEXT_LEVEL_1, Basis.TEXT_LEVEL_1_X, Basis.TEXT_LEVEL_Y, Basis.TEXT_LEVEL_W,
        Basis.TEXT_LEVEL_H);
    gc.drawImage(Basis.TEXT_LEVEL_2, Basis.TEXT_LEVEL_2_X, Basis.TEXT_LEVEL_Y, Basis.TEXT_LEVEL_W,
        Basis.TEXT_LEVEL_H);
    gc.drawImage(Basis.TEXT_LEVEL_3, Basis.TEXT_LEVEL_3_X, Basis.TEXT_LEVEL_Y, Basis.TEXT_LEVEL_W,
        Basis.TEXT_LEVEL_H);
